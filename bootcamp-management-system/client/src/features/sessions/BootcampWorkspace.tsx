...
const BootcampWorkspace = () => {
  ...
  const studentColumns: Column<DemoStudentRow>[] = [
    {
      header: 'Student Name',
      key: 'name',
      render: (item) => (
    ...
    },
    {
      ...
      key: 'enrollment',
      render: (item) => <span className="font-medium text-gray-500">{item.enrollment}</span>,
    },
    {
    ...
    },
    {
      header: 'Attendance',
      key: 'attendance',
      render: (item) => <span className="font-black text-vanguard-gray-800">{item.attendance}%</span>,
    },
    {
      header: 'Status',
      key: 'status',
  ...
  const demoStudents: DemoStudentRow[] = [
    {
      id: '1',
