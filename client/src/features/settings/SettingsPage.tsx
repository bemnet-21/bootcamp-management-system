            ...
            <div className="flex flex-col md:flex-row gap-10">
               ...
               <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-1.5">
                    <label className="text-[11px] font-black text-vanguard-gray-800 uppercase tracking-widest">Full Display Name</label>
                    <input type="text" defaultValue={user?.name} className="w-full h-11 px-4 bg-vanguard-gray-50 border border-vanguard-gray-100 rounded-xl text-sm focus:ring-1 focus:ring-vanguard-blue outline-none" />
                  </div>
                  <div className="space-y-1.5">
                    <label className="text-[11px] font-black text-vanguard-gray-800 uppercase tracking-widest">Email Endpoint</label>
                    <input type="email" defaultValue={user?.email} className="w-full h-11 px-4 bg-vanguard-gray-50 border border-vanguard-gray-100 rounded-xl text-sm opacity-60 cursor-not-allowed" disabled />
                  </div>
                  <div className="col-span-full space-y-1.5">
                    <label className="text-[11px] font-black text-vanguard-gray-800 uppercase tracking-widest">Professional Bio</label>
                    <textarea 
                      rows={4} 
                      className="w-full p-4 bg-vanguard-gray-50 border border-vanguard-gray-100 rounded-xl text-sm focus:ring-1 focus:ring-vanguard-blue outline-none resize-none"
                      placeholder="Share your expertise and interests within the organization..."
                    />
                  </div>
               </div>
            </div>
            <div className="flex justify-end pt-4 border-t border-vanguard-gray-100">
               <Button className="h-11 px-8 uppercase tracking-widest text-[12px] font-black">Save Changes</Button>
            </div>
          </div>
        );
      case 'security':
               ...
               <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                     <div className="space-y-1.5">
                       ...
                       <input type="password" placeholder="••••••••" className="w-full h-11 px-4 bg-vanguard-gray-50 border border-vanguard-gray-100 rounded-xl text-sm" />
                     </div>
                     <div className="space-y-1.5">
                       <label className="text-[11px] font-bold text-vanguard-muted">NEW PASSWORD</label>
                       <input type="password" placeholder="••••••••" className="w-full h-11 px-4 bg-vanguard-gray-50 border border-vanguard-gray-100 rounded-xl text-sm" />
                     </div>
                     <Button className="w-full h-11 uppercase text-[11px] font-black tracking-widest bg-vanguard-gray-800">Commit New Credentials</Button>
                  </div>
               </div>
